...
const Bottom: React.FC = () => {
  return (
    <div className={styles.container + ' flex flex-col p-10 justify-center items-center'}>
      <div className='basis-[70%] w-screen flex max-lg:flex-col items-center justify-center gap-[8vw]'>
      ...
      <div className='basis-[10%] '>
        <p className='text-xl'>Install our chrome extension and contribute towards a greener society</p>
      </div>
      <div className={styles.btn + ' flex basis-[20%] items-center justify-center  w-screen font-bold text-green-500'}>
